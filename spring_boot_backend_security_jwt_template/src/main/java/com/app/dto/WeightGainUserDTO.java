...
public class WeightGainUserDTO {
	...
	public WeightGainUserDTO(Long loginId, Set<Role> roles, String email, String firstName, String lastName,
	...
	public WeightGainUserDTO() {
		super();
	}

	@Override
	public String toString() {
		return "WeightGainUser[loginId=" + loginId + ", roles=" + roles + ", email=" + email + ", firstName="
